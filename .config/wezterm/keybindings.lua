...
local binds = {
    ...
    -- -- Focus on Tabs
    -- define_binding("a", act.ActivateTab(0)),
    -- define_binding("s", act.ActivateTab(1)),
    -- define_binding("d", act.ActivateTab(2)),
    -- define_binding("f", act.ActivateTab(3)),
    -- define_binding("g", act.ActivateTab(4)),
